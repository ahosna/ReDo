...
class RotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rotation" do
    assert_difference('Rotation.count') do
      post rotations_url, params: { rotation: { face: @rotation.face, redo_id: @rotation.redo_id } }
    end
  ...
  test "should update rotation" do
    patch rotation_url(@rotation), params: { rotation: { face: @rotation.face, redo_id: @rotation.redo_id } }
