...
class FacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create face" do
    assert_difference('Face.count') do
      post faces_url, params: { face: { face_id: @face.face_id, redo_id: @face.redo_id, status: @face.status, text: @face.text } }
    end
  ...
  test "should update face" do
    patch face_url(@face), params: { face: { face_id: @face.face_id, redo_id: @face.redo_id, status: @face.status, text: @face.text } }
